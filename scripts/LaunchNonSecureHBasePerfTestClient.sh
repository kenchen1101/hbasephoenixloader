...
usage() {
    ...
    echo "    [Example: sh LaunchNonSecureHBasePerfTestClient.sh --num_hconn=4 --num_writers=4 --num_xchg=20 --num_topic=20 --num_keys_per_ET=40 --rowkey_data_len=20 --write_batch_size=40]" 1>&2    
}

# Set all the environment variables
configEnv() {
    export PERF_CLIENT_HOME=/home/vikuser/vikas/phoenixdist/
